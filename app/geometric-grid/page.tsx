    ...
    <div className="min-h-screen bg-neutral-100">
      <div className="container mx-auto py-10 px-4">
        <div className="max-w-4xl mx-auto">
          <div className="mb-8">
            <h1 className="text-4xl font-bold mb-2 text-neutral-900">Geometric Grid</h1>
          ...
          <div className="mt-6 p-6 bg-white rounded-lg border border-neutral-200">
            ...
            <div className="mt-4">
              <h3 className="font-semibold mb-2 text-neutral-900">Shape Types:</h3>
            ...
            <div className="mt-4">
              <h3 className="font-semibold mb-2 text-neutral-900">Drawing Technique:</h3>
              <ul className="text-sm text-neutral-700 space-y-1 ml-4">
