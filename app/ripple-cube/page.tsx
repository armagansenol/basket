    ...
    <div className="min-h-screen bg-neutral-950">
      <div className="container mx-auto py-10 px-4">
        <div className="max-w-4xl mx-auto">
          <div className="mb-8">
            <h1 className="text-4xl font-bold mb-2 text-white">Ripple Cube</h1>
          ...
          <div className="mt-6 p-6 bg-neutral-800 rounded-lg border border-neutral-700">
            ...
            <div className="mt-4">
              <h3 className="font-semibold mb-2 text-white">Shader Features:</h3>
            ...
            <div className="mt-4">
              <h3 className="font-semibold mb-2 text-white">Lighting Setup:</h3>
              <ul className="text-sm text-neutral-300 space-y-1 ml-4">
            ...
            <div className="mt-4">
              <h3 className="font-semibold mb-2 text-white">Wave Parameters:</h3>
