...
export default function BloodborneSpriteShowcasePage() {
  return (
    <div className="min-h-screen bg-[radial-gradient(circle_at_25%_20%,#f4f4f4_0%,#e8e8e8_45%,#dbdbdb_100%)] px-4 py-10 text-zinc-900">
      <div className="mx-auto max-w-7xl space-y-8">
        <header className="space-y-3">
          <p className="text-xs uppercase tracking-[0.2em] text-zinc-500">Game Asset Showcase</p>
        ...
        <section className="grid gap-6 sm:grid-cols-2">
          {sprites.map((sprite) => (
            <article
              key={sprite.file}
              className="rounded-xl border border-zinc-200 bg-white/85 p-4 shadow-[0_10px_26px_rgba(0,0,0,0.10)]"
            >
              <div className="mb-3 flex items-center justify-between">
                <h2 className="text-sm font-medium text-zinc-800">{sprite.label}</h2>
                <span
              ...
              <div className="relative overflow-hidden rounded-lg border border-zinc-200 bg-zinc-100/70">
                <Image
              ...
              <p className="mt-3 text-xs text-zinc-500">/imagegen/{sprite.file}</p>
            </article>
          ))}
        </section>

        <section className="space-y-3 rounded-xl border border-zinc-200 bg-white/85 p-4 shadow-[0_10px_26px_rgba(0,0,0,0.10)]">
          <div className="flex items-center justify-between">
            <h2 className="text-sm font-medium text-zinc-800">Running Right Spritesheet (8x1)</h2>
          ...
          <div className="overflow-x-auto rounded-lg border border-zinc-200 bg-zinc-100/70 p-2">
            <Image
          ...
          <p className="text-xs text-zinc-500">/imagegen/running-right/bloodborne-run-right-spritesheet-8x1.png</p>
        </section>
      </div>
    </div>
  );
