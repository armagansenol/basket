    ...
    <div className="min-h-screen bg-neutral-100">
      <div className="container mx-auto py-10 px-4">
        <div className="max-w-4xl mx-auto">
          <div className="mb-8">
            <h1 className="text-4xl font-bold mb-2 text-neutral-900">Point Network</h1>
          ...
          <div className="mt-6 p-6 bg-white rounded-lg border border-neutral-200">
            ...
            <div className="mt-4">
              <h3 className="font-semibold mb-2 text-neutral-900">Layer System:</h3>
            ...
            <div className="mt-4">
              <h3 className="font-semibold mb-2 text-neutral-900">Connection Algorithm:</h3>
            ...
            <div className="mt-4">
              <h3 className="font-semibold mb-2 text-neutral-900">Perlin Noise Background:</h3>
              <ul className="text-sm text-neutral-700 space-y-1 ml-4">
            ...
            <div className="mt-4">
              <h3 className="font-semibold mb-2 text-neutral-900">Color Palette:</h3>
              <div className="flex flex-wrap gap-3">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-sm text-neutral-700">Magenta</span>
                </div>
                <div className="flex items-center gap-2">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-sm text-neutral-700">Black</span>
                </div>
              </div>
            ...
            <div className="mt-4">
              <h3 className="font-semibold mb-2 text-neutral-900">MyLine Function - Curved Connection:</h3>
              <pre className="text-xs text-neutral-600 p-3 bg-neutral-100 rounded border border-neutral-200 overflow-x-auto">
