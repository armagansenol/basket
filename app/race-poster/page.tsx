    ...
    <div className="min-h-screen bg-neutral-950">
      <div className="container mx-auto py-10 px-4">
        <div className="max-w-4xl mx-auto">
          <div className="mb-8">
            <h1 className="text-4xl font-bold mb-2 text-white">Race Poster</h1>
          ...
          <div className="mt-8 grid gap-6 md:grid-cols-2">
            ...
            <div className="p-6 bg-neutral-800 rounded-lg border border-neutral-700">
              <h2 className="text-xl font-semibold mb-3 text-white">Effects & Animation</h2>
              <ul className="space-y-2 text-neutral-300">
            ...
            <div className="mt-4">
              ...
              <div className="grid grid-cols-4 md:grid-cols-8 gap-3">
                <div className="flex flex-col items-center gap-1">
                  ...
                  <span className="text-xs text-neutral-400">Orange</span>
                </div>
                <div className="flex flex-col items-center gap-1">
                  <div className="w-8 h-8 rounded-full flex items-center justify-center text-xs font-bold"
                       style={{ background: "hsl(180, 75%, 60%)", color: "hsl(240, 50%, 10%)" }}>I</div>
                  <span className="text-xs text-neutral-400">Teal</span>
                </div>
                <div className="flex flex-col items-center gap-1">
                  <div className="w-8 h-8 rounded-full flex items-center justify-center text-xs font-bold"
                       style={{ background: "hsl(330, 85%, 65%)", color: "hsl(240, 50%, 10%)" }}>-</div>
                  <span className="text-xs text-neutral-400">Pink</span>
                </div>
                <div className="flex flex-col items-center gap-1">
                  <div className="w-8 h-8 rounded-full flex items-center justify-center text-xs font-bold"
                       style={{ background: "hsl(280, 75%, 60%)", color: "hsl(240, 50%, 10%)" }}>S</div>
                  <span className="text-xs text-neutral-400">Violet</span>
                </div>
                <div className="flex flex-col items-center gap-1">
                  <div className="w-8 h-8 rounded-full flex items-center justify-center text-xs font-bold"
                       style={{ background: "hsl(350, 80%, 65%)", color: "hsl(240, 50%, 10%)" }}>T</div>
                  <span className="text-xs text-neutral-400">Red</span>
                </div>
                <div className="flex flex-col items-center gap-1">
                  <div className="w-8 h-8 rounded-full flex items-center justify-center text-xs font-bold"
