    ...
    <div className="min-h-screen bg-neutral-100">
      <div className="container mx-auto py-10 px-4">
        <div className="max-w-4xl mx-auto">
          <div className="mb-8">
            <h1 className="text-4xl font-bold mb-2 text-neutral-900">Typewriter Poem</h1>
          ...
          <div className="mt-8 grid gap-6 md:grid-cols-2">
            ...
            <div className="p-6 bg-white rounded-lg border border-neutral-200">
              <h2 className="text-xl font-semibold mb-3 text-neutral-900">Visual Style</h2>
              <ul className="space-y-2 text-neutral-700">
          ...
          <div className="mt-6 p-6 bg-white rounded-lg border border-neutral-200">
            <h2 className="text-xl font-semibold mb-3 text-neutral-900">The Poem</h2>
            <div className="mb-4 p-4 bg-neutral-100 rounded border border-neutral-200">
              <p className="text-neutral-700 italic mb-2">
                "The Second Coming" by William Butler Yeats (First Stanza):
              </p>
              <div className="text-sm text-neutral-600 space-y-2 font-serif">
            ...
            <h3 className="font-semibold mb-2 text-neutral-900">Technical Implementation:</h3>
            ...
            <div className="mt-4">
              <h3 className="font-semibold mb-2 text-neutral-900">Noise Parameters:</h3>
            ...
            <div className="mt-4">
              <h3 className="font-semibold mb-2 text-neutral-900">Grid Specifications:</h3>
