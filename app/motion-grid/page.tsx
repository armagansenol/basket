    ...
    <div className="min-h-screen bg-neutral-950">
      <div className="container mx-auto py-10 px-4">
        <div className="max-w-4xl mx-auto">
          <div className="mb-8">
            <h1 className="text-4xl font-bold mb-2 text-white">Motion Grid</h1>
          ...
          <div className="mt-8 grid gap-6 md:grid-cols-2">
            <div className="p-6 bg-neutral-800 rounded-lg border border-neutral-700">
              <h2 className="text-xl font-semibold mb-3 text-white">Animation Features</h2>
          ...
          <div className="mt-6 p-6 bg-neutral-800 rounded-lg border border-neutral-700">
            ...
            <div className="mt-4">
              <h3 className="font-semibold mb-2 text-white">Motion Types:</h3>
            ...
            <div className="mt-4">
              <h3 className="font-semibold mb-2 text-white">Animation System:</h3>
            ...
            <div className="mt-4">
              <h3 className="font-semibold mb-2 text-white">Grid Configuration:</h3>
              <ul className="text-sm text-neutral-300 space-y-1 ml-4">
            ...
            <div className="mt-4">
              <h3 className="font-semibold mb-2 text-white">Easing Formula:</h3>
              <pre className="text-sm text-neutral-400 p-3 bg-neutral-900 rounded border border-neutral-700 overflow-x-auto">
{`easeInOutQuint(x) {
